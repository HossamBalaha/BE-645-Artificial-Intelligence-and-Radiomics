...
# Initial Creation Date: Jul 1st, 2025
# Last Modification Date: Jul 1st, 2025
...
datasetMatPath = r"../../Datasets/Brain Tumor 3 Cats Dataset/brainTumorDataPublic_1-766"
datasetPath = r"../../Datasets/Brain Tumor 3 Cats Dataset/brainTumorDataPublic_1-766 (Images)"

if (not os.path.exists(datasetPath)):
  PreprocessBrainTumorDatasetFigshare1512427(
    datasetMatPath,  # Path to the .mat file containing the image data.
    datasetPath,  # Path to save the converted image.
...
featuresPath = r"Data/Brain Tumor 3 Cats Dataset (Mini Project 01) Features.csv"  # Path to save the features CSV file.

# Check if plotting is enabled.
if (doPlotting):
  # Define the path for storing visualizations.
  visualStoragePath = r"Data/Brain Tumor 3 Cats Dataset (Mini Project 01) Visualizations"
