...
rlMatrix = CalculateGLRLMRunLengthMatrix3D(
  volumeCropped,  # Input 3D volume data.
  theta,  # Analysis angle in radians.
  isNorm=True,  # Normalize the run-length matrix.
  ignoreZeros=True,  # Exclude zero intensity values from analysis.
)
