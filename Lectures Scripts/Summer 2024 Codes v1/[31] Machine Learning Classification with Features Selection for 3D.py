...
resultsStorePath = os.path.join(baseDir, "MedMNISTv2_Nodule_MNIST_3D_Test_FS_Results.csv")
...
# resultsStorePath = os.path.join(baseDir, "MedMNISTv2_Organ_MNIST_3D_Train_FS_Results.csv")
...
for model in models:
  ...
  for technique in fsTechniques:
    ...
    for p in percentages:
      ...
      metrics, cm = TrainEvaluateModel(model, xTrainSub, yTrainEnc, xTestSub, yTestEnc)
